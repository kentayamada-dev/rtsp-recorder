import { Stack, Typography, ToggleButtonGroup, ToggleButton, type ToggleButtonGroupProps } from "@mui/material";
import type { ToggleFieldProps } from "./types";

export const ToggleField = <T extends string | number>({ label, value, options, onChange }: ToggleFieldProps<T>) => {
